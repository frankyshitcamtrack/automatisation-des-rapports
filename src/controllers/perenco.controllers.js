    ...
    await getRepportData(
      ...
      .then(async (res) => {
        ...
        if (objLenth > 0) {
          ...
          console.log(
            `no data found in ${RAPPORT_ACTIVITE_FLOTTE_PERENCO} ${ECO_DRIVING}`
          );
        }
      })
      .then(async () => {
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_ACTIVITE_FLOTTE_PERENCO} ${DETAIL_TRAJET}`
              );
            }
          })
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              const updateDataWithoutUser =
                utilisateurNullConduiteDeNuit(rangeData);

              const createIntervallesCol = addIntervalles(
                updateDataWithoutUser
              );
              ...
              console.log(
                `no data found in ${RAPPORT_ACTIVITE_FLOTTE_PERENCO} ${CONDUITE_DE_NUIT}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              const arrDataWithZone = zoneExcesDeVitesse(
                updateDataWithoutUser,
                EXCES_DE_VITESSE_LEGERE_VILLE
              );
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_LEGERE_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_SEVERE_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_LEGERE_HORS_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_SEVERE_HORS_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_LEGERE_NAT3_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              console.log(
                `no data found in ${RAPPORT_EXCES_DE_VITESSE_FLOTTE} ${EXCES_DE_VITESSE_SEVERE_NAT3_VILLE}`
              );
            }
          })
          .catch((err) => console.log(err));
...
async function generateHebdoRepportPerenco() {
  try {
    ...
    await getRepportData(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              await perencoXlsx(
                newArrData,
                SPEEDING_DETAIL,
                `${pathFileExcesVitesse}-${titleDate}.xlsx`,
                column
              );
            } else {
              console.log(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              await perencoXlsx(
                updateDataWithoutUser,
                ZONES,
                `${pathFileHorsZoneBonaberi}-${titleDate}.xlsx`,
                filterCol
              );
            } else {
              console.log(
                `no data found in ${RAPPORT_TRAVERSE_ZONE_BONABERI} ${ZONES}`
              );
            }
          })
          .catch((err) => console.log(err));
        ...
        await getRepportDataUnit(
          ...
          .then(async (res) => {
            ...
            if (objLenth > 0) {
              ...
              const updateDataWithoutUser =
                utilisateurNullDetailTrajet(rangeData);

              const newArrData = addCriticiteAndVitesseLimiteProps(
                updateDataWithoutUser
              );
              ...
              await perencoXlsx(
                newArrData,
                TRACKING_TRACAFIC,
                `${pathTracking}-${titleDate}.xlsx`,
                filterCol
              );
            } else {
              console.log(
                `no data found in ${TRACKING_TRACAFIC} ${TRACKING_TRACAFIC}`
              );
            }
          })
          .catch((err) => console.log(err));
      ...
      .then(async () => {
        await generateDashbordSpeedingPerenco(
          speedings,
          DASHBORD_SPEEDING,
          `${pathFileExcesVitesse}-${titleDate}.xlsx`
        );
        ...
        if (sender && receivers) {
          setTimeout(() => {
            sendMail(
              ...
              RAPPORT_TRAVERSE_ZONE_BONABERI,
              `${ACTIVITY_REPORT_SUBJECT_MAIL_PERENCO_TRAVERSER}`,
              `${RAPPORT_TRAVERSE_ZONE_BONABERI}.xlsx`,
              path.join(
                __dirname,
                `../../${pathFileHorsZoneBonaberi}-${titleDate}.xlsx`
              )
        ...
        if (sender && receivers) {
          setTimeout(() => {
            sendMail(
              ...
              RAPPORT_EXCES_DE_VITESSE_FLOTTE,
              `${ACTIVITY_REPORT_SUBJECT_MAIL_PERENCO_EXCES_VITESSE}`,
              `${RAPPORT_EXCES_DE_VITESSE_FLOTTE}.xlsx`,
              path.join(
                __dirname,
                `../../${pathFileExcesVitesse}-${titleDate}.xlsx`
              )
        ...
        if (sender && receivers) {
          setTimeout(() => {
            sendMail(
              ...
              TRACKING_TRACAFIC,
              `${ACTIVITY_REPORT_SUBJECT_MAIL_PERENCO_TRACKING}`,
              `${TRACKING_TRACAFIC}.xlsx`,
              path.join(__dirname, `../../${pathTracking}-${titleDate}.xlsx`)
            );
            deleteFile(
              path.join(__dirname, `../../${pathTracking}-${titleDate}.xlsx`)
            );
