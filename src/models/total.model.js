const { generateReportGlobal } = require('../services/total.service');
...
async function getTotalRepportDataUnit(ressourceClient, template, client, from, to, subGroup) {
...
async function getTotalRepportData(ressourceClient, template, client, from, to, subGroup) {
    let items = [];
    let repportDetail;
    let group;
    const generateRepport = await generateReportGlobal(ressourceClient, template, client, from, to, subGroup);
...
module.exports = { getTotalRepportData, getTotalRepportDataUnit }
